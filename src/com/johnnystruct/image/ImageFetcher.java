...
package com.johnnystruct.image;
...
import com.johnnystruct.config.BuildConfig;
...
public class ImageFetcher extends ImageResizer {
	...
	private void init(Context context) {
		HttpConnect.checkConnection(context);
			...
			if (mHttpDiskCache != null) {
				try {
					...
					if (snapshot == null) {
						...
						if (editor != null) {
							if (httpConnect.sendGetRequest(data,
									editor.newOutputStream(DISK_CACHE_INDEX)) == RequestStatus.CODE_TASK_RESULT_SUCCESS) {
								editor.commit();
							} else {
								editor.abort();
							}
